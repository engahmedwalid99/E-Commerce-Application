...
<body class="m-0 font-cairo bg-cream text-ink">
    ...
    <div class="grid grid-cols-1 md:grid-cols-[1.05fr_1fr] h-auto md:h-screen md:overflow-hidden" dir="ltr">
        ...
        <aside
            ...
            <div class="relative z-10 max-w-[420px] my-auto">
                ...
                <h1 class="font-tajawal font-black text-[38px] leading-[1.35] mb-4">
                    سجّل دخولك وابدأ <span class="text-gold">من حيث توقفت</span>
                </h1>
        ...
        <section
            ...
            <div class="w-full max-w-[400px] my-auto am:mt-[-20px] md:h-[100vh] max-[650px]:mt-[-55px]">
                <h2 class="font-tajawal font-extrabold text-[28px] m-0 mb-1.5">تسجيل الدخول</h2>
                <p class="text-muted text-[14.5px] m-0 mb-6">
                    ليس لديك حساب؟
                    <a href="{{ route('register') }}" class="text-navy font-bold no-underline border-b-[1.5px] border-gold">أنشئ حسابًا</a>
                </p>
