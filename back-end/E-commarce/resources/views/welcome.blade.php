...
<body class="m-0 font-cairo bg-cream text-ink">
        ...
        <div class="container relative z-10 mx-auto max-w-[1240px] px-4 sm:px-6 py-16 sm:py-20 md:py-24">
            <div class="flex flex-col mt-[70px] items-center text-center gap-5 max-w-2xl mx-auto">
                ...
                <h1 class="font-extrabold leading-[1.3] text-3xl sm:text-4xl md:text-5xl">
                    كل اللي محتاجه
                    <span class="text-gold">في مكان واحد</span>
                </h1>
    ...
    <div class="bg-white border-b border-line">
        <div
            class="container mx-auto max-w-[1240px] px-4 sm:px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 py-6">
            <div class="flex items-center gap-3">
                ...
                <div><b class="block text-sm">شحن سريع</b><span class="text-xs text-muted">خلال 2-4 أيام عمل</span>
                </div>
            </div>
            <div class="flex items-center gap-3">
                <div class="w-11 h-11 shrink-0 rounded-[11px] bg-gold/15 text-gold flex items-center justify-center">
                ...
                <div><b class="block text-sm">دفع آمن 100%</b><span class="text-xs text-muted">حماية كاملة
                        لبياناتك</span></div>
            </div>
            <div class="flex items-center gap-3">
                <div class="w-11 h-11 shrink-0 rounded-[11px] bg-gold/15 text-gold flex items-center justify-center">
                ...
                <div><b class="block text-sm">إرجاع سهل</b><span class="text-xs text-muted">خلال 14 يوم من
                        الاستلام</span></div>
            </div>
            <div class="flex items-center gap-3">
                <div class="w-11 h-11 shrink-0 rounded-[11px] bg-gold/15 text-gold flex items-center justify-center">
                ...
                <div><b class="block text-sm">دعم على مدار الساعة</b><span class="text-xs text-muted">نحن هنا
                        لمساعدتك</span></div>
            </div>
        </div>
    </div>
    ...
    <section class="container mx-auto max-w-[1240px] px-4 sm:px-6 py-12 sm:py-16">
        <div class="flex items-end justify-between gap-4 mb-7">
            ...
            <a href="{{ route('all_products') }}"
                class="font-bold text-xs sm:text-[13.5px] text-navy border-b-[1.5px] border-gold pb-0.5 whitespace-nowrap">عرض
                كل الفئات ←</a>
        </div>

        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
            <a href="#"
                class="bg-white border border-line rounded-2xl px-3 py-5 text-center transition-all hover:-translate-y-1 hover:shadow-[0_14px_28px_rgba(18,22,43,.08)] hover:border-gold">
                <div
                    class="w-12 h-12 sm:w-[52px] sm:h-[52px] rounded-full flex items-center justify-center mx-auto mb-3 bg-[#EFEAF9]">
                    <svg class="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="none" stroke="#7C5CD6"
                        stroke-width="1.8">
            ...
            <a href="#"
                class="bg-white border border-line rounded-2xl px-3 py-5 text-center transition-all hover:-translate-y-1 hover:shadow-[0_14px_28px_rgba(18,22,43,.08)] hover:border-gold">
                <div
                    class="w-12 h-12 sm:w-[52px] sm:h-[52px] rounded-full flex items-center justify-center mx-auto mb-3 bg-[#E7F2F9]">
                    <svg class="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="none" stroke="#2C8AC2"
                        stroke-width="1.8">
            ...
            <a href="#"
                class="bg-white border border-line rounded-2xl px-3 py-5 text-center transition-all hover:-translate-y-1 hover:shadow-[0_14px_28px_rgba(18,22,43,.08)] hover:border-gold">
                <div
                    class="w-12 h-12 sm:w-[52px] sm:h-[52px] rounded-full flex items-center justify-center mx-auto mb-3 bg-[#FBEFEA]">
                    <svg class="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="none" stroke="#D06B3D"
                        stroke-width="1.8">
            ...
            <a href="#"
                class="bg-white border border-line rounded-2xl px-3 py-5 text-center transition-all hover:-translate-y-1 hover:shadow-[0_14px_28px_rgba(18,22,43,.08)] hover:border-gold">
                <div
                    class="w-12 h-12 sm:w-[52px] sm:h-[52px] rounded-full flex items-center justify-center mx-auto mb-3 bg-[#EAF7EE]">
                    <svg class="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="none" stroke="#2E9E52"
                        stroke-width="1.8">
            ...
            <a href="#"
                class="bg-white border border-line rounded-2xl px-3 py-5 text-center transition-all hover:-translate-y-1 hover:shadow-[0_14px_28px_rgba(18,22,43,.08)] hover:border-gold">
                <div
                    class="w-12 h-12 sm:w-[52px] sm:h-[52px] rounded-full flex items-center justify-center mx-auto mb-3 bg-[#FBEFF4]">
                    <svg class="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="none" stroke="#C24E80"
                        stroke-width="1.8">
            ...
            <a href="#"
                class="bg-white border border-line rounded-2xl px-3 py-5 text-center transition-all hover:-translate-y-1 hover:shadow-[0_14px_28px_rgba(18,22,43,.08)] hover:border-gold">
                <div
                    class="w-12 h-12 sm:w-[52px] sm:h-[52px] rounded-full flex items-center justify-center mx-auto mb-3 bg-gold/15">
                    <svg class="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="none" stroke="#B8912B"
                        stroke-width="1.8">
    ...
    <section class="container mx-auto max-w-[1240px] px-4 sm:px-6 pb-12 sm:pb-16">
        ...
        <div class="inline-flex gap-2 mb-6 bg-[#F1F0EB] p-1.5 rounded-full w-fit">
            <div class="px-4 sm:px-5 py-2 rounded-full text-xs sm:text-[13.5px] font-bold bg-navy text-white">الأكثر
                مبيعًا</div>
        </div>
    ...
    <section class="container mx-auto max-w-[1240px] px-4 sm:px-6 pb-12 sm:pb-16">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
            <div
                class="relative overflow-hidden rounded-[22px] p-8 sm:p-10 min-h-[200px] sm:min-h-[220px] flex flex-col justify-center bg-gradient-to-br from-navy2 to-navy text-white">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-sm opacity-85 mb-5 max-w-[280px]">ساعات ذكية، سماعات، وإكسسوارات تقنية بأسعار لا
                        تُفوّت.</p>
                </div>
            </div>
            <div
                class="relative overflow-hidden rounded-[22px] p-8 sm:p-10 min-h-[200px] sm:min-h-[220px] flex flex-col justify-center bg-gradient-to-br from-[#F3E7C9] to-[#EAD9A0] text-navy">
    ...
    <section class="container mx-auto max-w-[1240px] px-4 sm:px-6">
        <div
            class="bg-gradient-to-br from-[#F3E7C9] to-[#EAD9A0] rounded-3xl px-6 sm:px-12 py-10 sm:py-12 text-center my-6">
            ...
            <form class="flex flex-col sm:flex-row gap-2.5 max-w-md mx-auto" action="{{ route('subscribe') }}"
                method="POST">
                @csrf
